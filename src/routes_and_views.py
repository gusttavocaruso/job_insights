...
# Auxilio de Alex Corrêa @alexcorreadasilva27 e..
@bp.route("/job/<index>")
def job(index):
    jobs = read("src/jobs.csv")
    especific_job = get_job(jobs, index)

    return render_template("job.jinja2", job=especific_job)
# .. documentação: https://www.treinaweb.com.br/blog/o-que-e-o-jinja2
